...
First, check if claude-friends is set up by running `claude-friends whoami`. If it returns "not-set-up", run the onboarding flow described in the /setup-claude-friends command BEFORE doing anything else.
